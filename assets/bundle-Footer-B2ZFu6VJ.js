...
const deployment = {"repoUrl":"https://github.com/ob-simatic/home"};
...
async function getCategories() {
  try {
    const cats = await import('./bundle-urlFormatter-2bN1NoPj.js').then(n => n.a);
    return cats.default || {};
  } catch {
...
async function getProducts() {
  try {
    const prods = await import('./bundle-products-BGofbmFG.js');
